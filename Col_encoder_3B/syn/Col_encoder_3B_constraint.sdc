...
create_clock -name CLK -period 50 -waveform {0 25.00} [get_ports clk]

set_clock_latency 5 [get_clocks CLK]
set_clock_uncertainty -setup 5 [get_clocks CLK]
...
set_input_delay -clock [get_clocks CLK] -add_delay  12.50 [remove_from_collection [all_inputs] [get_ports clk]]

set_output_delay 12.50 -clock CLK [all_outputs]
